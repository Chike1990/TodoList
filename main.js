...
/* harmony import */ var _upDate_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _crud_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
function addTodo() {
  ...
  (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.createTodo)(todos, newTodo);
...
document.addEventListener('change', (e) => {
  ...
  if (classList.contains('todo__text')) {
    (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.updateTodo)(todos, value, parseInt(id, 10));
    localStorage.setItem('todos', JSON.stringify(todos));
    displayTodosOnUI();
  } else {
...
document.querySelector('.todo__clear-btn').addEventListener('click', () => {
  todos = (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.clearCompletedTodos)(todos);
  localStorage.setItem('todos', JSON.stringify(todos));
  displayTodosOnUI();
});
...
document.addEventListener('click', (e) => {
  if (e.target.classList.contains('todo__delete-icon')) {
    const index = parseInt(e.target.id, 10);
    (0,_crud_js__WEBPACK_IMPORTED_MODULE_2__.deleteTodo)(todos, index);
    localStorage.setItem('todos', JSON.stringify(todos));
    displayTodosOnUI();
  }
});
